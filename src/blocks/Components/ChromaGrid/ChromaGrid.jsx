...
const ChromaGrid = ({
  ...
  return (
    <div
      ...
      className={`relative w-full h-full grid grid-cols-1 sm:grid-cols-2 gap-4 bg-white ${className}`}
      style={{
        "--r": `${radius}px`,
        "--x": "50%",
        "--y": "50%",
    ...
    >
      {data.map((c, i) => (
        ...
        >
          ...
          <footer className="relative z-10 p-3 text-slate-800 text-center text-xl sm:text-2xl font-sans grid grid-cols-[1fr_auto] gap-x-3 gap-y-1">
